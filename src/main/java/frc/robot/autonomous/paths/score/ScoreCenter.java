...
public class ScoreCenter extends AutonomousPath {
    ...
    protected SequentialCommandGroup getCommand() {
        ...
        output.addCommands(new DriveToCommand(new Pose2d(startx + 2, starty - 3.4, Rotation2d.fromDegrees(-45)),
        ...
        // Drives over balls
        output.addCommands(new DriveToCommand(new Pose2d(startx + 4, starty - 3.4, Rotation2d.fromDegrees(0)),
