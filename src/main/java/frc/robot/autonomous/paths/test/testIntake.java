...
public class testIntake extends AutonomousPath {
    ...
    protected SequentialCommandGroup getCommand() {
        ...
        output.addCommands(new ParallelCommandGroup(new DriveToCommand(new Pose2d(4, 0, Rotation2d.fromDegrees(0))),
        new IntakeCells(1)).withTimeout(6));
