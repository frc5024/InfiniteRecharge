...
public class PathGenerator {
    ...
    public static SequentialCommandGroup generate(Pose2d start, List<Translation2d> interiorPoints, Pose2d end,
        ...
        return new RamseteCommand(trajectory, DriveTrain.getInstance()::getPosition,
                ...
                new PIDController(RobotConstants.ControlGains.kPDriveVel, 0, 0),
                new PIDController(RobotConstants.ControlGains.kPDriveVel, 0, 0), DriveTrain.getInstance()::setVoltage,
