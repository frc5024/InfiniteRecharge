...
public class AutonomousStartpoints {
     ...
     * the field.
     */
    public static final Pose2d SECTOR_LINE_RIGHT = new Pose2d(Units.inchesToMeters(120) - RobotConstants.DriveTrain.Measurements.DRIVEBASE_WIDTH / 2,
    ((FieldConstants.FIELD_WIDTH / 2) - RobotConstants.DriveTrain.Measurements.DRIVEBASE_LENGTH / 2)*-1,
